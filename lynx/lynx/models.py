...
class SipPlan(models.Model):
    ...
    plan_progress = models.CharField(max_length=150, choices=PLANS, blank=True, null=True, default="Plan not complete")
    assessment = models.CharField(max_length=150, choices=ASSESSMENTS, blank=True, null=True, default="Not assessed")
