...
urlpatterns = [
    ...
    path('sip-plan-confirm/<int:pk>', views.SipPlanDeleteView.as_view(), name='sip-plan-delete'),
    # path('sip-plan-confirm/<int:pk>/<int:plan_id>', views.SipPlanDeleteView.as_view(), name='sip-plan-delete'),
