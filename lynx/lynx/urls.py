...
urlpatterns = [
    ...
    path('get-hour-validation/(?P<authorization_id>\w{1,50}&P<billed_units>\w{1,50}))', views.get_hour_validation, name='get_hour_validation'),
    ...
    path('get-date-validation/(?P<authorization_id>\w{1,50}&P<note_date>\w{1,50}))', views.get_date_validation, name='get_date_validation'),
