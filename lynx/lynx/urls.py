...
urlpatterns = [
    ...
    path('intake-note-confirm/<int:pk>', views.IntakeNoteDeleteView.as_view(), name='intake-note-delete'),
    path('progress-report-confirm/<int:pk>/<int:auth_id>', views.ProgressReportDeleteView.as_view(), name='pr-delete'),
    path('lesson-note-confirm/<int:pk>', views.LessonNoteDeleteView.as_view(), name='ln-delete'),
