...
if day_of_week == 1: #this is running whenever I restart the server, this will mean it can only run on weekdays
    ...
    def address():
        ...
        msg = EmailMultiAlternatives(subject, text_content, username,
                                     ['mjtolentino247@gmail.com', 'jhuynh@societyfortheblind.org'])
