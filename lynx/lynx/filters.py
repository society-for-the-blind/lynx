...
from .models import IntakeNote, Sip1854Note, SipNote, SipPlan, Sip1854Plan,  Assignment, ContactInfoView, AGES, COUNTIES, PROGRAM
...
class AssignmentFilter(django_filters.FilterSet):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.data == {}:
            ...
            sipplans_prefetch = Prefetch('contact__sipplan_set', queryset=SipPlan.objects.select_related('user').all(), to_attr='related_sipplans')
            sip1854plans_prefetch = Prefetch('contact__sip1854plan_set', queryset=Sip1854Plan.objects.select_related('user').all(), to_attr='related_sip1854plans')
